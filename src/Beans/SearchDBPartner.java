...
public class SearchDBPartner 
{
	...
	public List getResult(String partnerName) throws Exception
	{
		...
		String sqlSel1 = "select proteinInteraction from polyq2.interaction where partnerName like '%" + partnerName + "%';";

...
public class SearchDBAll 
{
	...
	public List getResult(String id) throws Exception
	{
		...
		}catch(ClassNotFoundException e)
		{
			...
			String sqlSel1 = "select dbid, uniprotID, name, disease, review, domain from polyq2.protein;";

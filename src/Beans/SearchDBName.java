...
public class SearchDBName 
{
	...
	public List getResult(String name) throws Exception
	{
		...
		String sqlSel1 = "select * from polyq2.protein where allName like '%" + name + "%' or gene like '%" + name + "%';";

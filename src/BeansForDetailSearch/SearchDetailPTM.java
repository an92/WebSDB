...
public class SearchDetailPTM 
{
	...
	public List getResult(int proteinID) throws Exception
	{
		...
		String sqlSel1 = "select * from polyq2.ptms where protein ='" + proteinID + "';";
...
//			String ptmType = rs.getString(4);
//			
//			
//			
//			
//			/**
//			 * search the ptm type with the ptm type number
//			 */
//			//String sel1 = "select "
//		}
